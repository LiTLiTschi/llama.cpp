...
void ggml_compute_forward_argsort_thresh(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_moe_up_gate(const struct ggml_compute_params * params, struct ggml_tensor * dst);
